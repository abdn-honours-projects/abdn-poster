\documentclass[a2,portrait]{lab-poster}
...
\major{CS4527: Single Honours Computing Project}
% \major{CS4594: Joint Honours Computing-Physics Project}
\supervisor{Mary Supervisor}
\email{student.name@abdn.ac.uk}

\themecolor{NavyBlue}
\unilogo{images/logoAberdeen.pdf}
% \lablogo{images/lablogo.pdf}  % Optional: set a separate lab logo
